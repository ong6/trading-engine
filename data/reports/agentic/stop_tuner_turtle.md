...
_role **tuner** (weekly stop / breakout params) · param version **v1** · 0 applied / 0 rejected change(s) · 1 lesson(s) · generated 2026-08-12 22:33 UTC._
...
* AI return over the window: **+0.18%**
* Twin return over the window: **−1.74%**
* **Spread (AI − twin): +1.92%**
