...
_role **tuner** (weekly sleeve weights) · param version **v1** · 0 applied / 0 rejected change(s) · 1 lesson(s) · generated 2026-08-13 22:35 UTC._
...
* AI return over the window: **+0.98%**
* Twin return over the window: **+0.98%**
* **Spread (AI − twin): +0.00%**
