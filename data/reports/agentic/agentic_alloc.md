...
_role **tuner** (weekly sleeve weights) · param version **v1** · 0 applied / 0 rejected change(s) · 1 lesson(s) · generated 2026-08-10 22:34 UTC._
...
* AI return over the window: **+0.38%**
* Twin return over the window: **+0.38%**
* **Spread (AI − twin): +0.00%**
