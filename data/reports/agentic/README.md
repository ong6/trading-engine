...
_5 paired book(s) · 5 of 5 AI book(s) exist in `portfolios` · generated 2026-08-04 09:54 UTC._
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [news_gated_momo](news_gated_momo.md) | `momo_stopped` | gater | **no data yet** — no `sim_equity` rows yet: news_gated_momo | · | · | · | · | · | v1 | 0 | 0 | · | · | 2027-02-01 |
| [adaptive_mr](adaptive_mr.md) | `adaptive_mr_frozen` | tuner | **no data yet** — no `sim_equity` rows yet: adaptive_mr, adaptive_mr_frozen | · | · | · | · | · | v1 | 0 | 0 | — | · | 2027-02-01 |
| [agentic_alloc](agentic_alloc.md) | `agentic_alloc_frozen` | tuner | **no data yet** — no `sim_equity` rows yet: agentic_alloc, agentic_alloc_frozen | · | · | · | · | · | v1 | 0 | 0 | — | · | 2027-02-01 |
| [stop_tuner_turtle](stop_tuner_turtle.md) | `turtle_breakout` | tuner | **no data yet** — no `sim_equity` rows yet: stop_tuner_turtle | · | · | · | · | · | v1 | 0 | 0 | — | · | 2027-02-01 |
| [earnings_context_pead](earnings_context_pead.md) | `pead_ear` | gater | **no data yet** — no `sim_equity` rows yet: earnings_context_pead | · | · | · | · | · | v1 | 0 | 0 | · | · | 2027-02-01 |
