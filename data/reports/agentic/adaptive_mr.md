...
_role **tuner** (weekly mean-reversion params) · param version **v1** · 0 applied / 0 rejected change(s) · 1 lesson(s) · generated 2026-08-11 22:34 UTC._
...
* AI return over the window: **−0.64%**
* Twin return over the window: **−0.64%**
* **Spread (AI − twin): +0.00%**
