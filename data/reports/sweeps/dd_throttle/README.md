...
_6 candidate(s) · **6 trials** · 10-fold protocol · bootstrap seed 20260820 · generated 2026-08-22 08:46 UTC._

## Read this before the table

**4 of 6 ranked candidate(s) are `INDISTINGUISHABLE` from `ew_benchmark`** — their 90% confidence interval on median excess contains 0, so this evidence does not establish even the SIGN of their edge, let alone its size. That is the headline of this table; the ordering below it is a tie-break among rows most of which are not separated from the benchmark at all.
...
|---|---|---|---|---|---|---|---|
| `dd_trigger-0.15__derisk_frac-0.5` | **INDISTINGUISHABLE** | 10 | -4.33% | [-8.23%, +1.41%] | -6.16% | 40% | -36.47% |
| `dd_trigger-0.2__derisk_frac-0.5` | **distinguishable −** | 10 | -5.72% | [-10.17%, -0.10%] | -8.86% | 30% | -36.47% |
| `dd_trigger-0.1__derisk_frac-0.5` | **INDISTINGUISHABLE** | 10 | -7.18% | [-14.75%, +0.31%] | -9.20% | 30% | -36.47% |
| `dd_trigger-0.15__derisk_frac-0.0` | **INDISTINGUISHABLE** | 10 | -12.30% | [-32.36%, +2.01%] | -22.02% | 40% | -36.46% |
| `dd_trigger-0.2__derisk_frac-0.0` | **distinguishable −** | 10 | -12.30% | [-32.36%, -1.71%] | -22.50% | 30% | -27.05% |
| `dd_trigger-0.1__derisk_frac-0.0` | **INDISTINGUISHABLE** | 10 | -13.13% | [-32.36%, +0.97%] | -22.56% | 30% | -17.51% |
...
| | |
|---|---|
| Raw Sharpe (excess vs EW, per fold) | **-0.461** |
| Trials searched (N) | 6 |
| SR0 — Sharpe the luckiest of 6 zero-skill trials would be expected to show | +0.104 |
| **Deflated Sharpe (DSR) = P(true excess Sharpe > SR0)** | **0.003** |
