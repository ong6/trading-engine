...
| [P13](p13-market-data-source-hardening.md) | Market-data source hardening | active | Provider-neutral exact-response quotes/bars boundary plus one credential-gated official API; TradingView blocked by its terms; **awaiting provider credentials** |
