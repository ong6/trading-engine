# BUILDLOG — trading-engine (legacy, 2026-07-15 to 2026-09-17)

> Moved verbatim from the root `BUILDLOG.md` on 2026-09-24. Historical record only; the current
> log and its v2 format live in [`../../BUILDLOG.md`](../../BUILDLOG.md).
